...
class TestCpu(TestCase):
    ...
    def test_basic(self):
        ...
        self.assertAlmostEqual(desc[0][1], 0.74627, 5)
        self.assertAlmostEqual(desc[1][1], 0.49751, 5)
        self.assertAlmostEqual(desc[2][1], 0.0)
        self.assertAlmostEqual(desc[3][1], 0.248756, 5)
        self.assertAlmostEqual(desc[4][1], 99.25373, 5)
